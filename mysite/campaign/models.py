...
class Campaign(models.Model):
    ...
    def __str__(self) -> str:
        return self.vaccine.name.upper()+' | ' + self.center.name.upper()
...
class Slot(models.Model):
    ...
    maximum_capacity = models.IntegerField(default=0, null=True, blank=True)
    ...
    def reserve_vaccine(campaign_id, slot_id):
        ...
        if storage.total_quantity > 0 and storage.booked_quantity <storage.total_quantity and slot.reserved < slot.maximum_capacity:
